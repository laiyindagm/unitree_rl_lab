"""15-DOF rotation config V3a — Hardened Minimal Rotation.

Based directly on the proven 15dof_lcp config with MINIMAL changes:
  1. NaN safety: observation clipping + joint velocity termination + clip_actions
  2. Rotation-aware yaw tracking (drop-in replacement, same weight)
  3. yaw_rate_l1 for straight-walk parasitic yaw penalty
  4. 5% pure-rotation environments via rel_rotating_envs
  5. ang_vel curriculum to progressively widen yaw command range
  Total: 18 reward terms (vs 16 in base LCP)
"""
